...
public class ClazzServiceImpl extends BaseMongoServiceImpl<Clazz, Long, ClazzRepository> implements ClazzService {
	...
	*/
	@Override
	public Page<Clazz> getPage(Map<String, Object> searchParams, int page, int size)   {
		if (page != 0) {
			page = page - 1;
		}
	...
	@Override
	public Clazz getClzzByLongName(String longName) {
		return dao.getClazzByLongName(longName);
	}
